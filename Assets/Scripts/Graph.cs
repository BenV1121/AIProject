...
namespace GraphProject
{
    public class Graph<T>
    {
        ...
        {
            // TODO: Try and ensure there are no duplicate refferences.
        ...
        public Edge AddEdge(T a_start, T a_end, FindDelegate a_finder, float a_weight = 1, bool undirected = true)
        {
            return AddEdge(FindNode(a_start, a_finder), FindNode(a_end, a_finder), 
                a_weight, undirected);
        }
